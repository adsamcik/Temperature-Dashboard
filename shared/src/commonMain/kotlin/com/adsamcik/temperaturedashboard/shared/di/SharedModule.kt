 ...
 * factory (each with different constructors).
 */
val sharedModule: Module = module {
    ...
    // Database — DatabaseFactory is provided per platform; this single uses it.
    ...
    // Interpreter + coordinator (BleScanner injected by platform module)
    single { AdvertisementInterpreter(get()) }
    single { ScanningCoordinator(get(), get(), get(), get()) }
}
